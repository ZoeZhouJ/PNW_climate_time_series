...
**The model shows a statistically significant positive trend in minimum summer temperature over the years. For every one-year increase, `tmax` is expected to increase by 0.10253 degree. Both the slope and the overall model are highly significant (p-values \< 0.001)**
