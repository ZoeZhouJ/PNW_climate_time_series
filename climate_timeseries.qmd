...
Daily (GHCN-Daily), Version 3. NOAA National Climatic Data Center. http://doi.org/10.7289/V5D21VHZ [April 11th, 2025].
...
## Minimum Temperature
Between 1998 to 2024, the minimum temperature shows increasing trends in summer months, especially from May to Semptember. We can test the trend using the **Mann-Kendall** test to see if our observation is statistically significant. 
...
summary(res)
```
**The model shows a statistically significant positive trend in maximum summer temperature over the years. For every one-year increase, `tmax` is expected to increase by 0.10253 degree. Both the slope and the overall model are highly significant (p-values < 0.001)**
 ...
 **A flood day (precipitation ≥ 1) is expected to occur roughly every 99 days on average.**
